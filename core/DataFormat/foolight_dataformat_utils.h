/**
 * \file foolight_dataformat_utils.h
 *
 * \ingroup DataFormat
 * 
...
/** \addtogroup DataFormat
    ...
    @{*/
#ifndef FOOLIGHT_DATAFORMAT_UTILS_H
#define FOOLIGHT_DATAFORMAT_UTILS_H
...
namespace foolight{
  ...
  public:
    ...
    /// Default ctor
    product_id(const unsigned short type = foolight::data::kDATA_TYPE_MAX,
