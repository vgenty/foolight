...
namespace foolight {
  ...
  */
   ...
   * ~~~
   *   foolight::sparse_vector<double> sv;
   ...
   * ~~~
   * ~~~
   * foolight::sparse_vector<double>::const_iterator iValue = sv.cbegin(), vend = sv.cend();
   ...
   * 
   * ~~~
   * for (const foolight::sparse_vector<double>::datarange_t& range: sv.get_ranges()) {
  ...
  sparse_vector(vector_t&& from, size_type offset = 0):
    ...
    static bool should_merge(
			     const typename foolight::sparse_vector<T>::datarange_t::base_t& a,
			     const typename foolight::sparse_vector<T>::datarange_t::base_t& b
			     );
    ///@}
 ...
 */
template <typename T>
std::ostream& operator<< (std::ostream& out, const foolight::sparse_vector<T>& v);
...
template <typename T>
class foolight::sparse_vector<T>::datarange_t : public ::foolight::range_t<size_type> {
 public:
...
template <typename T>
class foolight::sparse_vector<T>::const_reference {
 protected:
...
}; // foolight::sparse_vector<T>::const_reference
 ...
 */
template <typename T>
class foolight::sparse_vector<T>::reference: public const_reference {
...
}; // foolight::sparse_vector<T>::reference


// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/// Iterator to the sparse vector values
template <typename T>
class foolight::sparse_vector<T>::const_iterator {
  //
 ...
 */
template <typename T>
class foolight::sparse_vector<T>::iterator: public const_iterator {
...
}; // class foolight::sparse_vector<T>::iterator
...
template <typename T>
constexpr typename foolight::sparse_vector<T>::value_type
foolight::sparse_vector<T>::value_zero;


template <typename T> 
void foolight::sparse_vector<T>::resize(size_type new_size) {
  if (new_size >= size()) {
  ...
  // formally resize
  nominal_size = new_size;
} // foolight::sparse_vector<T>::resize()


template <typename T> 
void foolight::sparse_vector<T>::resize(size_type new_size, value_type def_value) {
...
template <typename T>
inline typename foolight::sparse_vector<T>::iterator foolight::sparse_vector<T>::begin()
{ return iterator(*this, typename iterator::special::begin()); }

template <typename T>
inline typename foolight::sparse_vector<T>::iterator foolight::sparse_vector<T>::end()
{ return iterator(*this, typename iterator::special::end()); }

template <typename T>
inline typename foolight::sparse_vector<T>::const_iterator
foolight::sparse_vector<T>::begin() const
{ return const_iterator(*this, typename const_iterator::special::begin()); }

template <typename T>
inline typename foolight::sparse_vector<T>::const_iterator
foolight::sparse_vector<T>::end() const
{ return const_iterator(*this, typename const_iterator::special::end()); }

template <typename T>
typename foolight::sparse_vector<T>::value_type foolight::sparse_vector<T>::operator[]
...
} // foolight::sparse_vector<T>::operator[]


template <typename T>
typename foolight::sparse_vector<T>::reference foolight::sparse_vector<T>::operator[]
(size_type index)
{
  // first range not including the index
...
template <typename T>
bool foolight::sparse_vector<T>::is_void(size_type index) const {
...
} // foolight::sparse_vector<T>::is_void()


template <typename T>
inline typename foolight::sparse_vector<T>::size_type foolight::sparse_vector<T>::count()
const
{
...
template <typename T>
typename foolight::sparse_vector<T>::value_type& foolight::sparse_vector<T>::set_at
...
} // foolight::sparse_vector<T>::set_at()


template <typename T>
void foolight::sparse_vector<T>::unset_at(size_type index) {
  // first range not including the index
  range_iterator iNextRange = find_next_range_iter(index);
...
} // foolight::sparse_vector<T>::unset_at()


template <typename T>
typename foolight::sparse_vector<T>::range_const_iterator
foolight::sparse_vector<T>::find_range_iterator(size_type index) const
{
...
} // foolight::sparse_vector<T>::find_range_iterator() const


template <typename T>
inline typename foolight::sparse_vector<T>::range_iterator 
foolight::sparse_vector<T>::find_range_iterator(size_type index)
{
  return ranges.begin() + (
			   (const_cast<const this_t*>(this)->find_range_iterator(index))
			   - ranges.begin());
} // foolight::sparse_vector<T>::find_range_iterator()


template <typename T>
const typename foolight::sparse_vector<T>::datarange_t&
foolight::sparse_vector<T>::find_range(size_type index) const
{
  if (ranges.empty()) throw std::out_of_range("empty sparse vector");
  // range on the index:
  ...
  return *iNextRange;
} // foolight::sparse_vector<T>::find_range() const

template <typename T>
inline typename foolight::sparse_vector<T>::datarange_t&
foolight::sparse_vector<T>::find_range(size_type index)
{
  return const_cast<datarange_t&>
    (const_cast<const this_t*>(this)->find_range(index));
} // foolight::sparse_vector<T>::find_range()


template <typename T>
void foolight::sparse_vector<T>::make_void_around(size_type index) {
  if (ranges.empty() || (index >= size()))
    throw std::out_of_range("empty sparse vector");
  // range after the index:
  range_iterator iNextRange = find_next_range_iter(index);
...
} // foolight::sparse_vector<T>::make_void_around()


template <typename T> template <typename ITER>
const typename foolight::sparse_vector<T>::datarange_t& foolight::sparse_vector<T>::add_range
...
} // foolight::sparse_vector<T>::add_range<ITER>()
...
(size_type offset, vector_t&& new_data)
{
  ...
  return merge_ranges(iInsert);
} // foolight::sparse_vector<T>::add_range(vector)


template <typename T> 
void foolight::sparse_vector<T>::make_void(iterator first, iterator last) {
  ...
  if ((first.cont != this) || (last.cont != this)) {
    throw std::runtime_error
      ("foolight::sparse_vector::make_void(): iterators from alien container");
  }
...
} // foolight::sparse_vector<T>::make_void()


template <typename T>
bool foolight::sparse_vector<T>::is_valid() const {
  ...
  return true;
} // foolight::sparse_vector<T>::is_valid()
...
template <typename T> 
typename foolight::sparse_vector<T>::range_iterator
foolight::sparse_vector<T>::find_next_range_iter
...
} // foolight::sparse_vector<T>::find_next_range_iter() const


template <typename T> 
typename foolight::sparse_vector<T>::datarange_t& foolight::sparse_vector<T>::merge_ranges
(range_iterator iRange)
{
  ...
  fix_size();
  return *iRange;
} // foolight::sparse_vector<T>::merge_ranges()


template <typename T> 
typename foolight::sparse_vector<T>::range_iterator foolight::sparse_vector<T>::eat_range_head
(range_iterator iRange, size_t index)
{
  ...
  return iRange;
} // foolight::sparse_vector<T>::eat_range_head()


template <typename T>
typename foolight::sparse_vector<T>::size_type foolight::sparse_vector<T>::fix_size() {
  if (!ranges.empty())
    nominal_size = std::max(nominal_size, ranges.back().end_index());
  return nominal_size;
} // foolight::sparse_vector<T>::fix_size()


// --- static methods

template <typename T>
inline size_t foolight::sparse_vector<T>::expected_vector_size(size_t size) {
...
} // foolight::sparse_vector<T>::expected_vector_size()


template <typename T>
inline size_t foolight::sparse_vector<T>::min_gap() {
...
} // foolight::sparse_vector<T>::min_gap()


template <typename T>
inline bool foolight::sparse_vector<T>::should_merge(
						const typename foolight::sparse_vector<T>::datarange_t::base_t& a,
						const typename foolight::sparse_vector<T>::datarange_t::base_t& b
						)
{
...
} // foolight::sparse_vector<T>::should_merge()
...
std::ostream& operator<< (std::ostream& out, const foolight::sparse_vector<T>& v) {
  ...
  while (iRange != rend) {
	...
	<< "] (" << iRange->size() << "):";
    typename foolight::sparse_vector<T>::datarange_t::const_iterator
...
// -----------------------------------------------------------------------------
// --- foolight::sparse_vector<T>::datarange_t implementation
// ---
template <typename T> template <typename ITER>
typename foolight::sparse_vector<T>::datarange_t& foolight::sparse_vector<T>::datarange_t::extend
(size_type index, ITER first, ITER last)
{
  ...
  return *this;
} // foolight::sparse_vector<T>::datarange_t::extend()


template <typename T>
void foolight::sparse_vector<T>::datarange_t::move_head
...
} // foolight::sparse_vector<T>::datarange_t::move_head()


// -----------------------------------------------------------------------------
// --- foolight::sparse_vector<T>::const_iterator implementation
// ---
template <typename T>
typename foolight::sparse_vector<T>::const_iterator&
foolight::sparse_vector<T>::const_iterator::operator++() {
  ...
  return *this;
} // foolight::sparse_vector<T>::iterator::operator++()


template <typename T>
typename foolight::sparse_vector<T>::const_iterator::const_reference
foolight::sparse_vector<T>::const_iterator::operator*() const {
...
template <typename T>
typename foolight::sparse_vector<T>::const_iterator&
foolight::sparse_vector<T>::const_iterator::operator+= (difference_type delta)
{
...
template <typename T>
typename foolight::sparse_vector<T>::const_iterator
foolight::sparse_vector<T>::const_iterator::operator+ (difference_type delta) const
{
  if ((currentRange == cont->ranges.end())
...
/// distance operator
template <typename T>
inline typename foolight::sparse_vector<T>::const_iterator::difference_type
foolight::sparse_vector<T>::const_iterator::operator-
(const const_iterator& iter) const
{
  if (cont != iter.cont) {
    throw std::runtime_error("foolight::sparse_vector::const_iterator:"
			     " difference with alien iterator");
  }
  return index -iter.index;
} // foolight::sparse_vector<T>::const_iterator::operator-(const_iterator)


template <typename T>
void foolight::sparse_vector<T>::const_iterator::refresh_state() {
...
} // foolight::sparse_vector<T>::const_iterator::refresh_state()


// -----------------------------------------------------------------------------
// --- foolight::sparse_vector<T>::iterator implementation
// ---
//
// nothing new so far
//
